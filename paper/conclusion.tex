...
rate rose from 57.6\% to 96.8\% relative to a static baseline, with complete
rank separation between arms in this scale-free outcome. Structural
fingerprints and rejection signatures were useful within-campaign feedback
signals, but their aggregate counts are not treated as cross-arm effects
because the arms used different budgets. Reusing the same
