...
A 96.8\% mean acceptance rate is close to a ceiling, and a
...
assumption, but $p \approx 0.0079$ on the acceptance-rate comparison is a
ceiling on how small an exact $p$-value five-per-arm observations can
produce, not a measure of effect size on its own, and we report the actual
