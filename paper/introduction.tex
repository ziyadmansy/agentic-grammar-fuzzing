...
\begin{itemize}
  ...
  \item A seeded, reproducible, five-run-per-arm empirical comparison
    ...
    96.8\% and structural diversity by 123\% relative to a static baseline
    on the same target, reported with explicit caveats about unequal
    per-arm budgets and without claiming statistical significance.
