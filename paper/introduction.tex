...
against a static baseline generator; separately, by reusing the entire
pipeline, unmodified, against a second, independent parser (parson) to test
whether the approach generalizes beyond one target and one set of grammar
